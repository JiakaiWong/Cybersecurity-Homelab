...
In this room, I learned the fundamental role of a Security Information and Event Management (SIEM) solution within a Security Operations Center (SOC). I explored how host-centric and network-centric log sources generate security-relevant events and why centralized log collection is essential for effective monitoring and investigation.

I also gained an understanding of key SIEM capabilities, including log normalization, event correlation, alert generation, and dashboard visualization. Additionally, I learned how detection rules are created and how SOC analysts investigate triggered alerts to determine whether they are true positives or false positives.

Through the hands-on simulation, I investigated a suspicious process execution involving `cudominer.exe`, examined the associated detection rule, identified the responsible user and host, and successfully classified the alert as a **True Positive**. This practical exercise reinforced the importance of log analysis, alert triage, and evidence-based decision-making in security operations.

Overall, this room provided a solid foundation for understanding how SIEM platforms enable threat detection, monitoring, and incident investigation in real-world environments.
